            ...
            <div className={styles.mainContainer}>
                <div className={styles.profileHeaderContainer}>
                    <div className={styles.profilePhotoContainer}>
                        {isEdit?
                        <>
                            <Image src={ userData.pfp ?? "/male_default.svg" } alt="Profile picture" fill sizes="(max-width: 768px) 100px, 150px" style={{ objectFit: 'cover' }} priority/>
                        ...
                        :
                        <Image src={ userData.pfp ?? "/male_default.svg" }  alt="Profile picture" fill sizes="(max-width: 768px) 100px, 150px" style={{ objectFit: 'cover' }}/>
                        }
                    </div>
