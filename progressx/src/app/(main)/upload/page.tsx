    ...
    <div className="mainWrapper">
      <div className={styles.uploadContainer}>
        ...
        <div className={styles.uploadButtonContainer}>
          <div onClick={() => {router.push('/profile?page=videos&submit=true')}} style={{ cursor: 'pointer' }}>
          ...
          <div onClick={() => {router.push('/profile?page=photos&submit=true')}} style={{ cursor: 'pointer' }}>
