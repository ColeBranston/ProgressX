...
export default function ProfileWeb() {
    ...
    async function handleProfileImageChange(e: ChangeEvent<HTMLInputElement>){
        ...
        const data = await fetch('api/user/userImages/uploadProfileImage',{
            method: "POST",
            body: form_data
        })
    ...
    useEffect(() => {
        console.log("PFP Link: ", userData.pfp)
        if (page) {
            switch(page) {
                case "videos":
                    setSelector(0)
                    ...
                    <div className={styles.mainContainer}>
                        <div className={styles.profileHeaderContainer}>
                            <div className={styles.profilePhotoContainer}>
                                ...
                                :
                                <Image src={ String(userData.pfp ?? "/male_default.svg") }  alt="Profile picture" fill sizes="(max-width: 768px) 100px, 150px" style={{ objectFit: 'cover' }}/>
                                }
                            </div>
                            <div className={styles.profileInfoContainer}>
                                <div className={styles.profileInfoRow}>
                                    ...
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={isEdit? styles.togglePrivacyButton : ""} onClick={togglePrivate}>
                                    ...
                                    :
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={isEdit? styles.togglePrivacyButton : ""} onClick={togglePublic}>
                                ...
                                <div className={styles.profileInfoRow}>
                                    ...
                                    <form style={{width: '100%', height: '100%'}}>
                                        <textarea className={styles.bioTextArea} placeholder={ userData.bio ? String(userData.bio) :"No Bio Yet" } onChange={ 
                                            (e) => setUserData((prev: UserData) => ({
                                                                ...prev,
                                                                bio: e.target.value,
                                                            }))}>
                                        </textarea>
                                    ...
                                    :
                                    <p className={styles.bioText}>{ userData.bio ? String(userData.bio) :"No Bio Yet" }</p>
                                    }
                                </div>
                            </div>
                        </div>
